...
{
    public partial class FormPhimloai : Form
    {
        ...
        public FormPhimloai(FormTrangChu formTrangChu, FormMain formMain)
            {
                InitializeComponent();
        ...
        private void FormPhimloai_Paint(object sender, PaintEventArgs e)
        {
